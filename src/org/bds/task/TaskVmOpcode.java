...
public class TaskVmOpcode extends SysVmOpcode {
     ...
     */
    protected String createCommands(String sysCmds, boolean strictRemoteDependencies) {
        HashMap<String, String> replace = new HashMap<>();
        StringBuilder sbDown = new StringBuilder();
        StringBuilder sbUp = new StringBuilder();

        // Download & upload remote dependencies, unless 'strictRemoteDependencies' is true
        if (taskDependency != null && !strictRemoteDependencies) {
    ...
    protected Task createTask(String sysCmds) {
        ...
        boolean strictRemoteDependencies = bdsThread.getBool(GlobalScope.GLOBAL_VAR_TASK_OPTION_STRICT_REMOTE_DEPENDENCIES);
        sysCmds = createCommands(sysCmds, strictRemoteDependencies);
        ...
        task.setStrictRemoteDependencies(strictRemoteDependencies);
