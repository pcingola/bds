...
public class TestCasesIntegrationRunAws extends TestCasesBaseAws {
    ...
    public TestCasesIntegrationRunAws() {
        dir = "test/integration/run_aws/";
    }
    ...
    public void test07_DetachedAwsTask() {
        // Set the output file
        String region = awsRegion();
        String url = bucketUrl(dir + "run_aws_07", "out.txt");
