...
public class TestCasesBase implements BdsLog {
     ...
     */
    protected void runOk(String testFileName) {
        runAndCheckExit(testFileName, 0);
    }
     ...
     */
    protected void runTestCasesPass(String testFileName) {
        BdsTest bdsTest = new BdsTest(testFileName, verbose, debug);
        bdsTest.setTestCases(true);
        bdsTest.run();
        bdsTest.checkRunOk();
    ...
    protected Bds runTestCasesPassCoverage(String testFileName, double coverageMin) {
        BdsTest bdsTest = new BdsTest(testFileName, verbose, debug);
        bdsTest.setCoverage(true);
        bdsTest.setCoverageMin(coverageMin);
        bdsTest.setTestCases(true);
