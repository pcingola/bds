...
public class TestCasesTail extends TestCasesBase {
    ...
    @Test
    public void test02() {
        String tail = TailFile.tail(dir + "tail_02.txt");
        Assert.assertEquals("Hi", tail);
    }

    @Test
    public void test03() {
        String tail = TailFile.tail(dir + "tail_03.txt");
        Assert.assertEquals("Hi\nbye\n", tail);
    }

    @Test
    public void test04() {
        String tail = TailFile.tail(dir + "tail_04.txt");
    ...
    public void test05() {
        ...
        String tail = TailFile.tail(dir + "tail_05.txt");
    ...
    @Test
    public void test06() {
        String tail = TailFile.tail(dir + "tail_06.txt");
