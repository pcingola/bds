...
public class TestCasesExecutioners extends TestCasesBase {
    ...
    public void test01_parsePidQstatRegex() {
        ...
        Config config = new Config(dir + "test_parsePidQstatRegex_qstat.config"); // We set here the 'PID_REGEX_CHECK_TASK_RUNNING' parameter
        ...
        // Parse 'qstat' lines
        String fileName = dir + "test_parsePidQstatRegex_qstat.txt";
    ...
    public void test02_parsePidQstatColumn() {
        ...
        // Parse 'qstat' lines
        String fileName = dir + "test_parsePidQstatColumn_qstat.txt";
        if (verbose) System.out.println("Reading file '" + fileName + "'");
        String file = Gpr.readFile(fileName);
        String[] lines = file.split("\n");
        Set<String> pids = ctr.parseCommandOutput(lines);
