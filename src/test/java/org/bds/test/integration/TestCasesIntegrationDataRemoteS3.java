...
public class TestCasesIntegrationDataRemoteS3 extends TestCasesBaseAws {
    ...
    public TestCasesIntegrationDataRemoteS3() {
        dir = "test/integration/data_remote_s3/";
    }
    ...
    public void test12_UploadS3() {
        runAndCheck(dir + "remote_12.bds", "ok", "true");
    }
    ...
    public void test13_S3() {
        ...
        runAndCheckStdout(dir + "remote_13.bds", expectedOutput);
    }
    ...
    public void test14_S3() {
        ...
        runAndCheckStdout(dir + "remote_14.bds", expectedOutput);
    }
    ...
    public void test15_S3() {
        ...
        runAndCheckStdout(dir + "remote_15.bds", expectedOutput);
    }
    ...
    public void test16_S3() {
        ...
        runAndCheckStdout(dir + "remote_16.bds", expectedOutput);
    }
    ...
    public void test17_S3() {
        ...
        runAndCheckStdout(dir + "remote_17.bds", expectedOutput);
    }
    ...
    public void test18_S3WriteS3Read() {
        runAndCheck(dir + "remote_18.bds", "ok", "true");
    }
    ...
    public void test31_S3Dir() {
        ...
        runAndCheck(dir + "remote_31.bds", "dd", "[bye.txt, bye_2.txt, hi.txt, hi_2.txt]");
    }
    ...
    public void test32_S3DirRegex() {
        ...
        runAndCheck(dir + "remote_32.bds", "dd", "[bye.txt, bye_2.txt]");
    }
    ...
    public void test33_S3DirPathRegex() {
        ...
        runAndCheck(dir + "remote_33.bds", "dd", "[" + urlParen + "/bye.txt, " + urlParen + "/bye_2.txt]");
    }
