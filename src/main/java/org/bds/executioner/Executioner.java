...
public abstract class Executioner extends Thread implements NotifyTaskState, PidParser, BdsLog {
    ...
    /**
     * Add a custom resource to all hosts in this exectioner's system
     */
    public void addCustomResource(String resourceName, long count) {
        for (Host host : system) {
            host.getResources().setCustomResource(resourceName, count);
