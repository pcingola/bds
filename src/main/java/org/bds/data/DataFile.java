...
public class DataFile extends Data {
    ...
    /**
     * Delete file or dir 'f'
     * - If 'f' is a file, delete it
     * - If 'f is a directory, recursively delete all entries and then delete the directory
     */
    public boolean deleteRecursively(File f) {
        if (!f.exists()) return false;
        if (f.isDirectory()) {
            // Delete all directory entries recursively
        ...
        debug("Deleting file/dir '" + f + "'");
        return f.delete(); // Delete directory once all the entries have been deleted
    }
